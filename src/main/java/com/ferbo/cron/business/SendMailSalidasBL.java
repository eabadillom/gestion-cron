	...
	public void exec(Periodo periodo, String... numerosCliente) {
	    ...
	    try {
	        ...
	        if(isRunning == false) {
	            ...
	            log.info("El proceso de envío de reportes de salidas ya se encuentra en ejecución.");
	        }
	...
	throws SQLException {
		...
		for(ClienteContacto clienteContacto : clienteContactos) {
			...
			if(clienteContacto.isInventario() == false) {
			    log.info("Contacto no habilitado para envío de reportes de salidas..." + clienteContacto);
			    continue;
			}
